...
const ScreenOld = {
        ...
        onMounted(() => {
            ...
            window.addEventListener("keydown", function(e) {
                ...
                if (e.key === '#') {
                    ...
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[0] + ", " + BitmapStore.getColorRam()[0])
                    console.log('char #2 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(8,15+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[1] + ", " + BitmapStore.getColorRam()[1])
                    console.log('char #3 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(16,23+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[2] + ", " + BitmapStore.getColorRam()[2])
                    console.log('char #4 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(320,327+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[40] + ", " + BitmapStore.getColorRam()[40])
                    console.log('char #5 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(328,335+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[41] + ", " + BitmapStore.getColorRam()[41])
                    console.log('char #6 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(336,343+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[42] + ", " + BitmapStore.getColorRam()[42])
                    console.log('char #7 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(640,647+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[80] + ", " + BitmapStore.getColorRam()[80])
                    console.log('char #8 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(648,655+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[81] + ", " + BitmapStore.getColorRam()[81])
                    console.log('char #9 ------------------------------------------------')
                    BitmapStore.getBitmap().slice(656,663+1).forEach( v => console.log (v + ','))
                    console.log('ScreenOld/Col: ' + BitmapStore.getScreenRam()[82] + ", " + BitmapStore.getColorRam()[82])
    ...
    render() {
        console.log('Render ScreenOld......... ', this.modeCycle)
        ...
        console.log('Render ScreenOld End')
        return result
    }
